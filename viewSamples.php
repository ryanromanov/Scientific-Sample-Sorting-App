	...
	<div class="container push-down">
		...
		<?php
			while ($row = mysqli_fetch_assoc($result)) {
				echo "<div class='row sampleRow'><div class='col-sm-2 col-sm-offset-1'>" . $row['Number'] . "\nhello\n</div> <div class='col-sm-2 push-right'>" . $row['Box'] . "</div> <div class='col-sm-2 push-right'>" . $row['Row'] . "</div> <div class='col-sm-2 push-right'>" . $row['Level'] . "</div></div>";
			}
